...
for (const slope of slopes) {
    ...
    console.log('going right', slope.x, 'and down', slope.y, 'would lead to encountering', treeCount, 'trees');
}

console.log('product of tree encounters is', collisions.reduce((acc, n) => acc * n))